  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-120 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-2 w-full translate-y-12 scale-x-150 bg-black blur-2xl"></div>
        ...
        <div className="absolute inset-auto z-40  w-full -translate-y-[12.5rem] bg-black "></div>
      </div>
