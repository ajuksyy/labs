...
import OptionKeyIcon from "../../../public/images/svg/OptionKeyIcon";
import AceternityLogo from "../../../public/images/svg/AceternityLogo";
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-50 bg-black"
    >
      <motion.div
        style={{
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-4">
          <span className="text-[#9A9A9A] text-sm">⭐ Product Overview</span>
        </div>
        <h1 id="product-overview-title" className="text-3xl md:text-4xl font-semibold text-white mb-4">
          Components at a glance
        </h1>
        <p className="text-[#9A9A9A] text-sm md:text-base max-w-2xl mx-auto">
          Explore our component library and design system. Track progress and updates across our product development lifecycle.
        </p>
      </motion.div>
      {/* Lid */}
      <Lid
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-transparent to-teal-500/20 rounded-lg" />
        </div>
      </motion.div>
    </div>
  );
  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        ...
        <KBtn className="" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex justify-end w-full pr-1">
            <OptionKeyIcon className="h-[6px] w-[6px]" />
          </div>
          <div className="flex justify-start w-full pl-1">
...
export const OptionKey = ({ className }: { className: string }) => {
  return (
    <OptionKeyIcon className={className} />
  );
};

const AceternityLogoIcon = () => {
  return (
    <AceternityLogo className="h-3 w-3 text-white" />
  );
};
